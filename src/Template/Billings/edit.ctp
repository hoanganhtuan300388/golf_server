            ...
            <?= $this->Form->create($billing, ['class' => 'form-horizontal']) ?>
                <div class="box-body">
                    <div class="form-group <?= $this->Form->isFieldError('id') ? 'has-error' : '' ?>">
                        ...
                        <div class="col-sm-5">
                            <?= $this->Form->label('id', $billing['id'], ['id' => 'id', 'class' => 'form-control']) ?>
                            <?= $this->Form->error('id') ?>
                        </div>
                    </div>
                    <div class="form-group <?= $this->Form->isFieldError('user_account_id') ? 'has-error' : '' ?>">
                        ...
                        <div class="col-sm-5">
                            <?= $this->Form->text('user_account_id', ['id' => 'user_account_id', 'class' => 'form-control']) ?>
                    ...
                    <div class="form-group <?= $this->Form->isFieldError('billing_type') ? 'has-error' : '' ?>">
                        ...
                        <div class="col-sm-5">
                            <?= $this->Form->select('billing_type', [1 => __('1 month'), 2 => __('3 months'), 3 => __('6 months'), 4 => __('one year')],
                                ['id' => 'billing_type_edit', 'class' => 'form-control']) ?>
                    ...
                    <div class="form-group <?= $this->Form->isFieldError('status') ? 'has-error' : '' ?>">
                        <?= $this->Form->label('status', __('billing_type'), ['class' => 'col-sm-2 control-label']) ?>
                        <div class="col-sm-5">
                            <?= $this->Form->label('status', $billing['status'], ['id' => 'status', 'class' => 'form-control']) ?>
                    ...
                    <div class="form-group <?= $this->Form->isFieldError('combined_object_flg') ? 'has-error' : '' ?>">
                        ...
                        <div class="col-sm-5">
                            <?= $this->Form->select('combined_object_flg', $labelBill['combined_object_flg'], ['id' => 'combined_object_flg', 'class' => 'form-control']) ?>
                            <?= $this->Form->error('combined_object_flg') ?>
                        </div>
                    </div>
                    <div class="form-group <?= $this->Form->isFieldError('billing_end_date') ? 'has-error' : '' ?>">
                        <?= $this->Form->label('billing_end_date', __('billing_update_at'), ['class' => 'col-sm-2 control-label']) ?>
                        <div class="col-sm-5">
                            <?= $this->Form->label('', $billing['billing_update_at'], ['id' => 'billing_update_at', 'class' => 'form-control']) ?>
                        </div>
                    </div>
                    <div class="form-group <?= $this->Form->isFieldError('billing_update_reason') ? 'has-error' : '' ?>">
                        ...
                        <div class="col-sm-5">
                            <?= $this->Form->text('billing_update_reason', ['id' => 'billing_update_reason', 'class' => 'form-control input-sm']) ?>
                    ...
                    <div class="form-group <?= $this->Form->isFieldError('billing_update_by') ? 'has-error' : '' ?>">
                        ...
                        <div class="col-sm-5">
                            <?= $this->Form->label('billing_update_by', $billing['billing_update_by'], ['id' => 'billing_update_by', 'class' => 'form-control']) ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            ...
                            <?= $this->Html->link(__('Delete'), ['action' => 'delete',$billing['id']],['type' => 'reset', 'class' => 'btn btn-danger', 'confirm' => __('Certainly deleted data?')]) ?>                        </div>
                        </div>
                    </div>
                </div>
            <?= $this->Form->end() ?>
